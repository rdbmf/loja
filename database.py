...
CREATE TABLE IF NOT EXISTS bot_config(
    ...
    main_img TEXT DEFAULT 'https://i.ibb.co/7WfMhhM/avatar-1521775404.jpg',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@sltm7',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@sltm7',                                    -- Canal de notícias
...
-- Db principal de cartões --
CREATE TABLE IF NOT EXISTS cardapio_solds(
    nome TEXT PRIMARY KEY NOT NULL,
    descricao TEXT,                                                        linkimg TEXT,
    added_date TEXT DEFAULT (datetime('now','localtime')),                  -- Data de adição na db
     owner INTEGER NOT NULL,                                               -- ID de quem comprou
